...
public class Control24DeviceUtil {
	...
	private static final byte OUT5S1[] = {(byte) 0x01, 0x10, 0x00, 0x03, 0x00, 0x02, 0x04, 0x00, 0x04, 0x00, 0x32, 0x73, (byte) 0xAE};
	private static final byte OUT5S2[] = {(byte) 0x01, 0x10, 0x00, 0x08, 0x00, 0x02, 0x04, 0x00, 0x04, 0x00, 0x32, 0x32, (byte) 0x1D};
        ...
        try {
            ...
            switch (deviceName) {
                ...
                case "OUT24":
                    ...
                    break;
                case "OUT5S1":
                	OUT = Control24DeviceUtil.OUT5S1;
                	 break;
                case "OUT5S2":
                	OUT = Control24DeviceUtil.OUT5S2;
                	break;
            }
            onff(OUT, socket, dos);
   ...
   public static void main(String[] args) {
	   Control24DeviceUtil.controlDevice("192.168.16.254", 8080, "OUT1", "s");
}
}